...
async function updateUser(user) {
    ...
    users[i] = {
        ...
        googleId: user.googleId !== undefined ? user.googleId : existing.googleId,
        picture: user.picture !== undefined ? user.picture : existing.picture,
        sexuality: user.sexuality !== undefined ? user.sexuality : existing.sexuality,
        birthDate: user.birthDate !== undefined ? user.birthDate : existing.birthDate
    };
    await writeUsersArray(users);
}
...
async function registerAttachment({ id, userId, filename, mimeType, sizeBytes }) {
    ...
    index[id] = { userId, filename, mimeType: mimeType || '' };
